...
public class AppSendUtils {
    ...
    public static void main(String[] args) {
        String coords = "100.195178,25.905541";
        String result =connectURL("http://api.map.baidu.com/geoconv/v1/?coords="+coords+"&from=1&to=5&output=json&ak=e3ZohdqyB0RL98hFOiC29xqh","");
